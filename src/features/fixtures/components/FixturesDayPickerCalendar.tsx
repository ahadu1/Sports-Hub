  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: 'text-title-sm text-white',
        nav: 'absolute inset-x-0 top-0 flex items-center justify-between',
        button_previous: 'fixturesDateSelector__dayPickerNavButton',
        button_next: 'fixturesDateSelector__dayPickerNavButton',
        chevron: 'h-4 w-4',
        month_grid: 'w-full border-collapse',
        weekdays: 'grid grid-cols-7 gap-y-2',
        weekday:
          'flex h-8 items-center justify-center text-center text-body-sm-strong uppercase tracking-[0.08em] text-app-text-subtle',
        weeks: 'grid gap-y-1',
        week: 'grid grid-cols-7',
        day: 'flex items-center justify-center p-0',
        day_button: 'fixturesDateSelector__dayPickerDayButton',
        today:
